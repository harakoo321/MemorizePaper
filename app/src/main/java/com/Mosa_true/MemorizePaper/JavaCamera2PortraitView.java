...
@TargetApi(21)
public class JavaCamera2PortraitView extends CameraBridgeViewBase {
    ...
    public JavaCamera2PortraitView(Context context, int cameraId) {
        super(context, cameraId);
    }

    public JavaCamera2PortraitView(Context context, AttributeSet attrs) {
        super(context, attrs);
